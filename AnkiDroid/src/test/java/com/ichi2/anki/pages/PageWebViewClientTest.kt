...
// the rebuild times are kept per page path for the whole process, so every test uses its own paths
...
class PageWebViewClientTest {
    ...
    private inner class Page(
        ...
        fun rendererGone() = client.onRenderProcessGone(webView, mock<RenderProcessGoneDetail>())
    }
